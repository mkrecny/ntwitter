...
Twitter.prototype.addUserToStream = function(url, content, content_type, callback) {
  if (typeof content === 'function') {
    callback = content;
    content = null;
    content_type = null;
...
// User resources
Twitter.prototype.showUsers = function(id, callback) {
...
Twitter.prototype.getPlaceTrends = function(woeid, callback) {
  this.getTrendsWithId(woeid, null, callback);
  return this;
}
...
// FIXME: Uses deprecated Twitter lists API
Twitter.prototype.getListMembers = function(list_id, params, callback) {
  /*if (typeof params === 'function') {
    callback = params;
    params = null;
  }

  var url = '/list/members.json';
...
Twitter.prototype.getFriendsIds = function(params, callback) {
  if (typeof id === 'function') {
    callback = id;
    id = null;
  }
